...
async function saveEvent(){
  try{
    const data = {
      ...
      publishDate:val('publishDate'), level:val('level'), allowedYears:selectedYears()||'ทุกชั้นปี', allowedFaculties:requiredMultiSelect('allowedFaculties','คณะ'), allowedMajors:requiredMultiSelect('allowedMajors','สาขา'), allowedStudentIds:selectedParticipantStudentIds()
    };
